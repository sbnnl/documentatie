#language: nl
Functionaliteit: Consolideer borgstelling use-case

  Abstract Scenario: Use-case permissie is juist
    Gegeven een gebruiker met de rollen "<rollen>"
    Dan heeft de gebruiker "<wel-niet>" de permissie "CONSOLIDEER_BORGSTELLING"
  ...
  Abstract Scenario: Use-case heeft de juiste autorisaties
    ...
    Wanneer use-case "consolideer borgstelling" wordt uitgevoerd
