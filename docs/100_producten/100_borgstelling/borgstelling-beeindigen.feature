...
Functionaliteit: Borgstelling beëindigen
  ...
  Scenario: Borgstelling beëindigen van afgegeven aanvraag
    ...
    En het "beëindiging borgstelling" is verwerkt
  ...
  Scenario: Borgstelling beëindigen van actieve aanvraag
