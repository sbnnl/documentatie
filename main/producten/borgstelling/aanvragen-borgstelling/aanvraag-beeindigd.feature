#language: nl (f165c39194f6db70580a17f39295d35a)
Functionaliteit: Aanvraag beëindigd use-case

  Abstract Scenario: Use-case permissie is juist
    Gegeven een gebruiker met de rollen "<rollen>"
    Dan heeft de gebruiker "<wel-niet>" de permissie "VERSTUUR_AANVRAAG_BEEINDIGD"
  ...
  Abstract Scenario: Use-case heeft de juiste autorisaties
    ...
    Wanneer use-case "verstuur aanvraag beeindigd" wordt uitgevoerd
